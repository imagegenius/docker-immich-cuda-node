pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'TORCH_VERSION'
    IG_USER = 'imagegenius'
    IG_REPO = 'docker-immich-cuda-node'
      ...
      steps {
        ...
        sh '''#!/bin/bash
              ...
              docker buildx build \
                ...
                --label \"org.opencontainers.image.url=https://github.com/imagegenius/docker-immich-cuda-node/packages\" \
                --label \"org.opencontainers.image.source=https://github.com/imagegenius/docker-immich-cuda-node\" \
                ...
                --label \"org.opencontainers.image.title=Immich-cuda-node\" \
                --label \"org.opencontainers.image.description=immich-cuda-node is a remote machine leaning worker for Immich\" \
